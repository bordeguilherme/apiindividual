...
public class LivroController {
	...
	public ResponseEntity <List<Livro>> listarLivros(){
		return new ResponseEntity<>
			(livroService.listarLivros(), HttpStatus.OK);
	}
	...
	public ResponseEntity<LivroResumidoDTO> getLivroResumidoPorId(@PathVariable Integer id){
		...
		if(livroResDTO == null) {
			return new ResponseEntity<>
				(livroResDTO, HttpStatus.NOT_FOUND);
		} else {
			return new ResponseEntity<>
				(livroService.getLivroResumidoPorId(id), HttpStatus.OK);
		}
	}
	...
	public ResponseEntity<Livro> salvar(@RequestBody Livro livro) {
		return new ResponseEntity<>
			(livroService.salvarLivro(livro), HttpStatus.CREATED);
	}
	
	@PutMapping
	public ResponseEntity<Livro> atualizar(@RequestBody Livro livro) {
		return new ResponseEntity<>
			(livroService.atualizarLivro(livro), HttpStatus.OK);
	}
