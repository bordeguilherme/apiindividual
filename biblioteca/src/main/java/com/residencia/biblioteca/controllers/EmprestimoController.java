...
public class EmprestimoController {
	...
	public ResponseEntity <List<Emprestimo>> listarEmprestimos(){
		return new ResponseEntity<>
			(emprestimoService.listarEmprestimos(), HttpStatus.OK);
	}
	...
	public ResponseEntity<Emprestimo> buscarPorId(@PathVariable Integer id){
		...
		if(emprestimo == null) {
			return new ResponseEntity<>
				(emprestimo, HttpStatus.NOT_FOUND);
		} else {
			return new ResponseEntity<>
	...
	public ResponseEntity<Emprestimo> salvar(@RequestBody Emprestimo emprestimo) {
		return new ResponseEntity<>
			(emprestimoService.salvarEmprestimo(emprestimo), HttpStatus.CREATED);
	}
	
	@PutMapping
	public ResponseEntity<Emprestimo> atualizar(@RequestBody Emprestimo emprestimo) {
		return new ResponseEntity<>
			(emprestimoService.atualizarEmprestimo(emprestimo), HttpStatus.OK);
	}
